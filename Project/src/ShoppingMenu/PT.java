...
public class PT extends javax.swing.JFrame {
    ...
    int selected;
    public static int sumPricePerItem;
...
//  
    ...
    public static void WriteToFile() {
        ...
        try {
            FileWriter myWriter = new FileWriter("CartTest.txt");
//            myWriter.write("Files in Java might be tricky, but it is fun enough!");
        int NumRow2 = jTable1.getRowCount();
            for (int i = 0; i < NumRow2; i++) {
                item = String.valueOf(jTable1.getValueAt(i, 0).toString());
                price = String.valueOf(jTable1.getValueAt(i, 2).toString());
                quantity = String.valueOf(jTable1.getValueAt(i, 1).toString());
                myWriter.write(item+"|"+quantity+"|"+price + "|");
//                item[i] = it;
//                System.out.println("item arr : " + item[i]);
            }
            
//             myWriter.write(lb.getText()+"/n"+sumPricePerItem);
            myWriter.close();
